...
public:
void create(int x, int y, int w, int h, CWindow* parent, int id, bool editable);
...
void getItemText(int idx, string& str) {
	int len = ::SendMessage(m_wnd, CB_GETLBTEXTLEN, (WPARAM) idx, 0);
	str.resize(len);
...
void getItemText(int idx, string& str) {
	int len = ::SendMessage(m_wnd, LB_GETTEXTLEN, (WPARAM) idx, 0);
	str.resize(len);
...
public:
void create(int x, int y, int w, int h, CWindow* parent, int id);
...
public:
	void create(int x, int y, int w, int h, CWindow* p, int id);
